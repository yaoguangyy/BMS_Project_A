...
static emlrtRTEInfo c1_emlrtRTEI = { 128,/* lineNo */
  57,                                  /* colNo */
  "allOrAny",                          /* fName */
  "D:\\matlab 2024b\\toolbox\\eml\\eml\\+coder\\+internal\\allOrAny.m"/* pName */
};
  ...
  *chartInstance)
{
  ...
  if (sf_get_output_port_reusable(chartInstance->S, 1) == 0) {
    ...
    c1_sdiStreamingWrapperFcn(chartInstance, 0, 3, 451U,
  ...
  c1_sdiStreamingWrapperFcn(chartInstance, 0, 4, 474U,
  ...
  c1_sdiStreamingWrapperFcn(chartInstance, 0, 11, 465U,
  ...
  c1_b_sdiStreamingWrapperFcn(chartInstance, 1, 0, 0U,
    &chartInstance->c1_is_c1_Balancing_Logic);
  c1_c_sdiStreamingWrapperFcn(chartInstance, 4, 1, 463U, (int32_T)
    (chartInstance->c1_is_c1_Balancing_Logic == 1U));
  c1_c_sdiStreamingWrapperFcn(chartInstance, 4, 2, 414U, (int32_T)
    (chartInstance->c1_is_c1_Balancing_Logic == 2U));
  c1_d_sdiStreamingWrapperFcn(chartInstance, 2, 0, 0U, 0);
  chartInstance->c1_is_finally_c1_Balancing_Logic = c1_IN_NO_ACTIVE_LEAF;
  chartInstance->c1_is_BalancingON = c1_IN_NO_ACTIVE_CHILD;
  c1_b_sdiStreamingWrapperFcn(chartInstance, 1, 2, 414U,
    &chartInstance->c1_is_BalancingON);
  c1_c_sdiStreamingWrapperFcn(chartInstance, 4, 3, 475U, (int32_T)
    (chartInstance->c1_is_BalancingON == 1U));
  c1_c_sdiStreamingWrapperFcn(chartInstance, 4, 4, 477U, (int32_T)
    (chartInstance->c1_is_BalancingON == 2U));
  c1_d_sdiStreamingWrapperFcn(chartInstance, 2, 0, 0U, 0);
  c1_d_sdiStreamingWrapperFcn(chartInstance, 2, 2, 414U, 0);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  if (chartInstance->c1_is_active_c1_Balancing_Logic == 0) {
    ...
    c1_c_sdiStreamingWrapperFcn(chartInstance, 4, 2, 414U, (int32_T)
      (chartInstance->c1_is_c1_Balancing_Logic == 2U));
    c1_d_sdiStreamingWrapperFcn(chartInstance, 2, 0, 0U, 1);
    ...
    switch (chartInstance->c1_is_c1_Balancing_Logic) {
     case c1_IN_BalancingOFF:
      ...
      if (c1_out) {
        ...
        c1_c_sdiStreamingWrapperFcn(chartInstance, 4, 4, 477U, (int32_T)
          (chartInstance->c1_is_BalancingON == 2U));
        c1_d_sdiStreamingWrapperFcn(chartInstance, 2, 0, 0U, 2);
        c1_d_sdiStreamingWrapperFcn(chartInstance, 2, 2, 414U, 1);
...
void mdlZeroCrossings_c1_Balancing_Logic(SFc1_Balancing_LogicInstanceStruct
  *chartInstance)
{
  _sfTime_ = sf_get_time(chartInstance->S);
}
  ...
  (SFc1_Balancing_LogicInstanceStruct *chartInstance)
{
  ...
  sf_mex_assign(&c1_e_y, sf_mex_create("y",
    &chartInstance->c1_is_active_c1_Balancing_Logic, 3, 0U, 0, 0U, 0), false);
  sf_mex_setcell(c1_y, 3, c1_e_y);
  c1_f_y = NULL;
  sf_mex_assign(&c1_f_y, sf_mex_create("y",
    &chartInstance->c1_is_c1_Balancing_Logic, 7, 0U, 0, 0U, 0), false);
  ...
  sf_mex_assign(&c1_j_y, sf_mex_create("y",
    &chartInstance->c1_is_finally_c1_Balancing_Logic, 7, 0U, 0, 0U, 0), false);
  sf_mex_setcell(c1_y, 8, c1_j_y);
  c1_k_y = NULL;
  sf_mex_assign(&c1_k_y, sf_mex_create("y",
    &chartInstance->c1_is_finally_BalancingON, 7, 0U, 0, 0U, 0), false);
  ...
  chartInstance, const mxArray *c1_st)
{
  ...
  c1_sdiStreamingWrapperFcn(chartInstance, 0, 3, 451U, chartInstance->c1_BalCmd);
    ...
    switch (chartInstance->c1_is_BalancingON) {
     case c1_IN_BalActive:
      ...
      if (c1_b_out) {
        ...
        c1_c_sdiStreamingWrapperFcn(chartInstance, 4, 4, 477U, (int32_T)
          (chartInstance->c1_is_BalancingON == 2U));
        c1_d_sdiStreamingWrapperFcn(chartInstance, 2, 0, 0U, 3);
        c1_d_sdiStreamingWrapperFcn(chartInstance, 2, 2, 414U, 2);
        chartInstance->c1_is_finally_c1_Balancing_Logic =
  ...
  (SFc1_Balancing_LogicInstanceStruct *chartInstance)
{
  ...
  uint32_T c1_k[12] = { 469U, 453U, 191U, 451U, 474U, 430U, 443U, 485U, 486U,
    487U, 492U, 465U };

  uint32_T c1_j[5] = { 0U, 463U, 414U, 475U, 477U };
  ...
  sdi_database_initialize(&chartInstance->c1_sdiBlockInfo, c1_j,
    &chartInstance->c1_sdiLoggedStatesBuffer[0], 5, c1_k,
    &chartInstance->c1_sdiLoggedDataBuffer[0], 12);
  if (chartInstance->c1_sdiLoggedStatesBuffer[0U] & 1) {
    sdi_register_child_activity_signal(&chartInstance->c1_sdiBlockInfo,
      "Balancing", "", 3, &c1_b[0U], &c1_c[0U], sizeof(uint32_T), 1, 0U);
  }

  if (chartInstance->c1_sdiLoggedStatesBuffer[0U] & 2) {
    sdi_register_leaf_activity_signal(&chartInstance->c1_sdiBlockInfo,
      "Balancing", "", 4, &c1_d[0U], &c1_e[0U], 1, 0U);
  }
  ...
  if (chartInstance->c1_sdiLoggedStatesBuffer[2U] & 1) {
    sdi_register_child_activity_signal(&chartInstance->c1_sdiBlockInfo,
      "BalancingON", "BalancingON", 3, &c1_f[0U], &c1_g[0U], sizeof(uint32_T), 1,
      414U);
  }
  ...
  if (chartInstance->c1_sdiLoggedStatesBuffer[2U] & 2) {
    sdi_register_leaf_activity_signal(&chartInstance->c1_sdiBlockInfo,
      "BalancingON", "BalancingON", 3, &c1_h[0U], &c1_i[0U], 1, 414U);
  }
...
const mxArray *sf_c1_Balancing_Logic_get_eml_resolved_functions_info(void)
{
  ...
  const char_T *c1_data[4] = {
    ...
    "84073a400f0f747530fb0ac8b40f663e1f1a1fdd3e98bc936f707c704962496abc6b1e302406ccbf3bc8b40f667e1001fb60f2d17eb12e5631b989253989490a"
    "a91589b90539a9c531a0500832323032488c714a2c29492daa8c0fae2c2e49cd85893a039365517e4e4e6a510c6a88e9e5a2fa2301873bf989f407ae7cc3cbc0",
    "01a6551aae32d2d33e860b2d5574b50f0a06cabe0a1ce6119b0ec570d8278026ef1966e4979be71c5c60609e18986ce218ea99e113ea8c704700017b08b98301"
    "079fd6e603003ba45b9a", "" };

  c1_nameCaptureInfo = NULL;
  emlrtNameCaptureMxArrayR2016a(&c1_data[0], 1608U, &c1_nameCaptureInfo);
  ...
  *c1_isValueBrowsable = 1U;
  switch (c1_ssIdNumber) {
   case 469U:
    ...
    c1_i = (int32_T)c1_r;
    sf_mex_assign(&c1_m, sf_mex_create("unnamed temp", &c1_i, 6, 0U, 0, 0U, 0),
                  false);
   ...
   case 453U:
    sf_mex_assign(c1_mxData, sf_mex_create("mxData",
      *chartInstance->c1_CellVoltages, 1, 0U, 1, 0U, 1, 6), false);
    break;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3072976371U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1061225086U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1391982982U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1130069116U);
}
...
{
  return "spMp0lp4IO5xfsStfuGM8EG";
}
...
const char* sf_c1_Balancing_Logic_get_post_codegen_info(void)
{
  ...
  const char* encStrCodegen [31] = {
    "eNrtWstvG0UYXyeulZSmlKLykFpRIYRQD8h9oLaoAid+BIs4CV0nRRCwJrtje5TZ2e3MbGpXrdR",
    "DD9w4cEfc6JEjR/6EXrhz4d4LEhckvtld25u1a++unTSorOQ4365/870fM7aWqdY0uE7D69klTc",
    "vB+wK85jT/OhHQmdDLv5/VbgX05klNM9qIyypr2lryy7BN3MJMd5tN0kmIZa61iTiyRAq+DFn4N",
    "hY2dSWxWTLhCWtijpkBCzg2l4n4CmK5lLC9issMxVncaROjrbdtl5orsCAyNxjtPo+v48pN4Fgi",
    "HBuygrEp29x2W+0KRa3xVuDyXrGNjT3hWoltJbDUXUepKmoulcShuNzBRpUJicAKYoK+ukQSF2U",
    "ncYQQoffQtuVQglh8W7eR0LED0SHxlmPC3w1XgvVi8gV+u4QhaXOCaNmiRRXhMbGbFOSsQVjTxH",
    "aWlizhXbfVIqylrMtdCzPQH+Ikhq2aRXsfc9TCGyxhDirtyh3Pwf24jJ+DVRWWqXLQtXyviFRYj",
    "295HywkUvKtGKyIKBXJsHXbWcP7mHr8S0iiFFiffwKwEMSs29uIqyxImEkuI3ddHGCLNjNJfA/v",
    "R1BewV2H4hkDTiwVUtgEM/dF7y80KSZdIW2rCGlUWluLyW8YW2US8yYycOzaxxERGAT24iohX5M",
    "ItEsVGqwkPS1jr4BZaqgmmi4r3bP5Htg4aZEd2EplQjI0Nlu4hCX2CkYZonsbUTemzJaACqfCY0",
    "tAxUrGF7Aqf1KBDWS0san6CaG4hoVaQMSuz9BHlkHbfSK7JSwMTpy4meQKbEIjUVaqdx28xfaYf",
    "Y9VuG3pwUQwJq4whqqBOIO2sAJtiXcrIHw8qTm+W1eRlWY8s5CkaFfFxipm0FmUrqoTIgOyqsxg",
    "dAOBpsHq5D60diaIkDBOdcteDpjePPpWJtk8+lpAX+3nUlXUOXgKQRtmMCkt73rDHq4TC3s3dAQ",
    "zhU8Gl+Kb1wZ8F+fG850L/jtKXCbAfRbCZUfY52wIdyagjcuNFQTTiQGmb6zZLWKM1vtUDHufCH",
    "C/zSfz01JAf+/N/lCeO3IwkA8i3rYgzplUqQIhDJ7bh7hQV5P4PtPDxLqirEroUZ9Qj9T/XgPQo",
    "QHwdihxaJgYskPUrr0rbNcerjDBH6cjOEWv1PSGN942VFmYjv93E/jfjuAU/fX6N6WPd/xMvYg7",
    "Xj6IHSXV7Sv5K3m0s4IkZGu3oXchQa3eXchYyW1KMd85qMGH1kCeGyF5Xp0QF0vB/fce/Z6ZBq8",
    "9fXx/Krw2nfxh/KT8fCPiD0VXt6+sW6yoO/nr6Avj2vJWtb22VfTX+yC0XmbEeuG4SPP5tLhx9S",
    "s7VL+yWgauaL4saeNxuV4Nu7X71/Wff8CP//z27X/OXfplmvrZPpmsbvXy93xvv9SfKPeHhq44/",
    "n8z4n9FC6fm5KlzrbrxUacpdNl0V2s3yqveer8ujpf3ZETe3v2L8JKqiqr1uVE1Q6UWuf6ePBrv",
    "uQn2WDwQ788+nQqff1CI4kfZKxexl6KhmRUt82D8ptdjoTAV/szDQpw+sBTRQ9ElTCUqYkq3bSq",
    "1Y6LPT/H0eSWij6KbtKVco85shupLen0uTqdPwH9zgj7nI/qc985WGkhN/bgxeoKajX7vzkS/SX",
    "XnXES/c75+IxU7Fnr90S2kna9Ar75SG+uz0uf9I/HTqPkdZjDY9KrMctW5RoNcHqy3kHC/NB/QS",
    "jYsNVtohow7B2cCHgP55jQkh+fg3ATcYmiG1Z4+LPjt5EHhhfYjLX8k/n094l9Fm0iiO5zAzK3O",
    "y7AhbT7D+nnzSOrnhYheF/w8bMJ2jtLuYdaZmzOpM2nm9pB+z603aefU434e8aLOP2bBL845RzY",
    "lLpMSpx0xblr9Dntfetw+n/Z85rjpEX0f539tyP/HV68vF5LNQe8E9Cf979iKbULNEaf8weM1jJ",
    "qjngb8n8yPlzc7Jp6WJsibC+X5o4Tz3tnQXGkoDatmp26r75hqyAnbO3O48mdinpeeiuTRKX+/H",
    "zTXSiUt/7mY/Eftaw8095T8f8y8HP5bjNhv0beflzl4Cv5z08XPui0HInj2yh5NvirBD8PfTyb4",
    "O/eS5Othxdv8jOPt/3rxH68Xhzy//K0l83Pve4Syml+CH+l9dXUZdqNdQfwvN3u3N7n6fVj/Ecd",
    "IjP7twovYB8Y9d5o/4Kd5bXXl89T7yH8B87cMTw==",
    ""
  };

  static char newstr [2217] = "";
  newstr[0] = '\0';
  for (i = 0; i < 31; i++) {
...
static void mdlSetWorkWidths_c1_Balancing_Logic(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(4116855826U));
  ssSetChecksum1(S,(1704175415U));
  ssSetChecksum2(S,(425649540U));
  ssSetChecksum3(S,(2955548157U));
}
