...
#include "Battery_Model_981c414b_49_ds_tdxy_p.h"
...
int32_T Battery_Model_981c414b_49_ds_tdxy_p ( const NeDynamicSystem * LC ,
...
; ( void ) LC ; out -> mTDXY_P . mNumCol = 110ULL ; out -> mTDXY_P . mNumRow
= 22ULL ; for ( i = 0 ; i < 111 ; i ++ ) { out -> mTDXY_P . mJc [ i ] =
...
-> mTDXY_P . mIr [ 31 ] = _cg_const_2 [ 31 ] ; out -> mTDXY_P . mIr [ 32 ] =
_cg_const_2 [ 32 ] ; out -> mTDXY_P . mIr [ 33 ] = _cg_const_2 [ 33 ] ; out
-> mTDXY_P . mIr [ 34 ] = _cg_const_2 [ 34 ] ; out -> mTDXY_P . mIr [ 35 ] =
_cg_const_2 [ 35 ] ; out -> mTDXY_P . mIr [ 36 ] = _cg_const_2 [ 36 ] ; out
-> mTDXY_P . mIr [ 37 ] = _cg_const_2 [ 37 ] ; ( void ) LC ; ( void ) out ;
return 0 ; }
