...
1 , - 1 , TARGET_STRING ( "Battery_Model/Solver\nConfiguration/EVAL_KEY/INPUT_11_1_1" ) , TARGET_STRING ( "Discrete" ) , "" , 0 , 0 , 0 , 0 , 0 , 0 , - 1 , 0 } , { 2 , - 1 , TARGET_STRING ( "Battery_Model/Solver\nConfiguration/EVAL_KEY/INPUT_12_1_1" ) , TARGET_STRING ( "Discrete" ) , "" , 0 , 0 , 0 , 0 , 0 , 0 , - 1 , 0 } , { 3 , - 1 , TARGET_STRING ( "Battery_Model/Solver\nConfiguration/EVAL_KEY/INPUT_13_1_1" ) , TARGET_STRING ( "Discrete" ) , "" , 0 , 0 , 0 , 0 , 0 , 0 , - 1 , 0 } , { 4 , - 1 , TARGET_STRING ( "Battery_Model/Solver\nConfiguration/EVAL_KEY/INPUT_14_1_1" ) , TARGET_STRING ( "Discrete" ) , "" , 0 , 0 , 0 , 0 , 0 , 0 , - 1 , 0 } , { 5 , - 1 , TARGET_STRING ( "Battery_Model/Solver\nConfiguration/EVAL_KEY/INPUT_15_1_1" ) , TARGET_STRING ( "Discrete" ) , "" , 0 , 0 , 0 , 0 , 0 , 0 , - 1 , 0 } , { 6 , - 1 , TARGET_STRING ( "Battery_Model/Solver\nConfiguration/EVAL_KEY/INPUT_1_1_1" ) , TARGET_STRING ( "Discrete" ) , "" , 0 , 0 , 0 , 0 , 0 , 0 , - 1 , 0 } , { 7 , - 1 , TARGET_STRING ( "Battery_Model/Solver\nConfiguration/EVAL_KEY/INPUT_2_1_1" ) , TARGET_STRING ( "Discrete" ) , "" , 0 , 0 , 0 , 0 , 0 , 0 , - 1 , 0 } , { 8 , - 1 , TARGET_STRING ( "Battery_Model/Solver\nConfiguration/EVAL_KEY/INPUT_3_1_1" ) , TARGET_STRING ( "Discrete" ) , "" , 0 , 0 , 0 , 0 , 0 , 0 , - 1 , 0 } , { 9 , - 1 , TARGET_STRING ( "Battery_Model/Solver\nConfiguration/EVAL_KEY/INPUT_4_1_1" ) , TARGET_STRING ( "Discrete" ) , "" , 0 , 0 , 0 , 0 , 0 , 0 , - 1 , 0 } , { 10 , - 1 , TARGET_STRING ( "Battery_Model/Solver\nConfiguration/EVAL_KEY/INPUT_5_1_1" ) , TARGET_STRING ( "Discrete" ) , "" , 0 , 0 , 0 , 0 , 0 , 0 , - 1 , 0 } , { 11 , - 1 , TARGET_STRING ( "Battery_Model/Solver\nConfiguration/EVAL_KEY/INPUT_6_1_1" ) , TARGET_STRING ( "Discrete" ) , "" , 0 , 0 , 0 , 0 , 0 , 0 , - 1 , 0 } , { 12 , - 1 , TARGET_STRING ( "Battery_Model/Solver\nConfiguration/EVAL_KEY/INPUT_7_1_1" ) , TARGET_STRING ( "Discrete" ) , "" , 0 , 0 , 0 , 0 , 0 , 0 , - 1 , 0 } , { 13 , - 1 , TARGET_STRING ( "Battery_Model/Solver\nConfiguration/EVAL_KEY/INPUT_8_1_1" ) , TARGET_STRING ( "Discrete" ) , "" , 0 , 0 , 0 , 0 , 0 , 0 , - 1 , 0 } , { 14 , - 1 , TARGET_STRING ( "Battery_Model/Solver\nConfiguration/EVAL_KEY/INPUT_9_1_1" ) , TARGET_STRING ( "Discrete" ) , "" , 0 , 0 , 0 , 0 , 1 , 0 , - 1 , 0 } , { 15 , - 1 , TARGET_STRING ( "Battery_Model/Solver\nConfiguration/EVAL_KEY/STATE_1" ) , TARGET_STRING ( "Discrete" ) , "" , 0 , 0 , 1 , 0 , 0 , 0 , - 1 , 0 } , { 0 , - 1 , ( NULL ) , ( NULL ) , ( NULL ) , 0 , 0 , 0 , 0 , 0 , 0 , - 1 , 0 } } ; static int_T rt_LoggedStateIdxList [ ] = { 14 , 9 , 10 , 11 , 12 , 13 , 0 , 1 , 2 , 3 , 4 , 5 , 6 , 7 , 8 , 15 } ;
#ifndef HOST_CAPI_BUILD
static void Battery_Model_InitializeDataAddr ( void * dataAddr [ ] ) {
dataAddr [ 0 ] = ( void * ) ( & mhghcysq2pf . gi2satt5z1 [ 0 ] ) ; dataAddr [
1 ] = ( void * ) ( & mhghcysq2pf . cv1b00ffxo [ 0 ] ) ; dataAddr [ 2 ] = ( void
* ) ( & mhghcysq2pf . fiwfx5yw42 [ 0 ] ) ; dataAddr [ 3 ] = ( void * ) ( &
...
uint_T rtDimensionArray [ ] = { 2 , 1 , 110 , 1 } ; static const real_T
...
{ 864687588U , 3996359540U , 1391645866U , 770214260U } , &
...
int rootTid ) { UNUSED_PARAMETER ( djmxej3cna ) ; systemRan [ 0 ] = ( sysRanDType * ) rootSysRanPtr ; systemRan [ 1 ] = ( NULL ) ; systemRan [ 2 ] = ( NULL ) ; systemRan [ 3 ] = ( NULL ) ; systemTid [ 1 ] = el50fl4kem [ 0 ] ; systemTid [ 2 ] = el50fl4kem [ 0 ] ; systemTid [ 3 ] = el50fl4kem [ 0 ] ; systemTid [ 0 ] = rootTid ; rtContextSystems [ 0 ] = 0 ; rtContextSystems [ 1 ] = 0 ; rtContextSystems [ 2 ] = 0 ; rtContextSystems [ 3 ] = 0 ; }
#endif
#ifndef HOST_CAPI_BUILD
...
. mmi , & mmiStaticInfoLogging ) ; Battery_Model_InitializeDataAddr ( djmxej3cna
-> DataMapInfo . dataAddress ) ; rtwCAPI_SetDataAddressMap ( djmxej3cna ->
DataMapInfo . mmi , djmxej3cna -> DataMapInfo . dataAddress ) ;
